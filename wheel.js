...
const vkcoin = new VKCOINAPI({
    key: 'B8SnSfcbN-hiwUX6k!22vIE_Ekoa5cjnes!6hCOvEzHo4!19tK',
userId: 480922940,
token: '8385383bf6d21113a7b72f413c0cea00c9dc928bdf3478870cc543652308fbe722dd0f64472f5ba9cb689'
});
//const vkcoin = null;
/* ------------------------- [ Бот ]  ------------------------- */
...
async function run() {
  await db.connect(function(err) {
	...
	await vkcoin.api.setShopName(`CasinoVKCOIN`);
